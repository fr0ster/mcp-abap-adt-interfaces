...
`@mcp-abap-adt/interfaces` is **the contract, and nothing else**. 353 exported
...
decision 24 — and 31.0.0 acted on it: the result shapes left — forty-eight of them, and their
